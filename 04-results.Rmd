...
```{r study2-ubf-rps6-rna-fig, echo=FALSE, warning=FALSE, message=FALSE, fig.scap = "Total RNA levels prediucted by UBF and rpS6 protein in Study II.", fig.cap="Upstream binding factor (UBF) (a) and ribosomal protein S6 (rpS6) (b) protein levels predicting Total RNA abundance. Estimates are derived from models presented in Table 5.4. Values are estimated means with 95\\% CrI.", fig.height=2.5, fig.width=4.72, fig.align='center'}
