...
Given the apparent importance of early-phase accumulation of total RNA and thus presumably ribosomal biogenesis for responses to resistance training, evident both in analyses between and within-participants, the second intervention aimed to further characterize this process.

The training protocol resulted in increased muscle mass, measured as muscle thickness of *m. vastus lateralis*, compared to the non-training control group (Figure \@ref(fig:study2-muscle-strength-mass)a). This increase coincided with an increase in strength, most pronounced when measured as isokinetic torque (Figure \@ref(fig:study2-muscle-strength-mass)b). The different training protocols (constant vs. variable volume) were analyzed together as they led to similar changes.
These observations indicate the general efficacy of the training program in inducing changes to the neuromuscular apparatus, specifically with regards to muscle mass.

```{r study2-muscle-strength-mass, echo=FALSE, warning=FALSE, message=FALSE, fig.scap = "Muscle mass and strength changes in Study II", fig.cap="Training induced changes in muscle mass (a) and strength (b) compared to non-training controls in Study II. Conditions in the experimental group are presented together.", fig.height=4.5, fig.width=3, fig.align='center'}
...
rrna_totrna_vs_control +
  ...
  draw_plot_label(x = c(0.15, 0.025), 
             y = c(0.98, 0.2), 
             vjust = 1,
             hjust = 0,
             label = c("a", "b"))
...
```{r study2-rrna-volume-conditions, echo=FALSE, warning=FALSE, message=FALSE, fig.scap = "Total RNA and ribosomal RNA in variable- and constant-volume training conditions.", fig.cap="Total RNA (a) and rRNA (b) characteristics in response to different volume conditions (constant- vs. variable-volume).", fig.height=6, fig.width=4, fig.align='center'}
...
```{r study2-rna-muscle-thickness, echo=FALSE, warning=FALSE, message=FALSE, fig.scap = "Relationship between total RNA increase and muscle hypertrophy in Study II", fig.cap="(a)", fig.height=5, fig.width=4.72, fig.align='center'}
