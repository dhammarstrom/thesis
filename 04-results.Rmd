...
In Study I, the average increases (Table \@ref(tab:csa-str-tab)) in muscle strength and mass in each volume condition corresponded to what could be expected
[@RN2007;<!-- Wernbom 2007 -->
@RN1741].<!-- Ahtiainen  -->
...
@RN1767].<!-- Schoenfeld  -->
Furthermore, by combining data from more recent studies indicates that a higher training volume is generally associated with increased muscle hypertrophy and strength gains (Figure \@ref(fig:comb-fig-s1) and \@ref(fig:comb-fig-s1).   
