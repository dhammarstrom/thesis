...
As already [discussed](#muscle-mass-growth), resistance training in Study I led to an increase in RNA per unit tissue weight. Furthermore, the magnitude of this increase was different between volume conditions (see Figure \@ref(ribo-markers). As gene expression analyses performed using e.g. qPCR or RNA sequencing comes with the assumption that an equal amount of biological material is used in analysis, an equal amount of total RNA is often used to satisfy such an assumption
[@RN2298;<!-- Damas 2018 -->
@RN2400; <!-- Robinson 2017-->
@RN2401].<!-- Laker 2017.-->
However, since the ratio of RNA to tissue weight has changed, analysesare derived from a lesser amount of tissue after training. 
