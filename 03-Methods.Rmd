...
In Study I, the low-volume protocol consisted of a single set of each exercise and the moderate-volume consisted of three sets per exercise. Three unilateral leg exercises were used (leg press, leg curl and knee extension). The moderate volume-leg commenced all sessions and the low volume-leg performed a single set of each exercise in the rest between second and third set of the moderate volume training protocol. Each training session started with a light standardized warm-up (5 min ergometer cycling and 10 repetitions each of push-ups, sit-ups, back-extensions and squats). Before each exercise in the main program one set of 10 repetitions were performed with approximately 50% of 1RM.  

In Study II, only unilateral knee-extension was performed in an effort to concentrate the stimulus to the quadriceps muscles.<!-- Check this --> The constant-volume leg performed six sets of 10RM throught the study and variable leg perfomed six sets in session one to four, three sets in session five to eight and nine sets in session nine to twelwe with same intensity (10RM).      
...
Muscle samples were obtained under local anesthesia ()   with a fine needle (12-14 gauge; Universal-plus, Medax, San Possidonio, Italy) operated with a spring loaded instrument (Bard Magnum, Bard Norway AS). 
