...
This resembled variations between leg (Type I, `r round(between_legs[1,4],2)`%-points; Type IIA, `r round(between_legs[2,4],2)`%-points; Figure \@ref(fig:fiber-methods-fig)c).
...
robust_fig <- robust %>%
  ...
  scale_fill_manual(values = c(group.study.color[c(2,3,6)])) +
...
filter(coef != "(Intercept)") %>%
  ...
  scale_color_manual(values = group.study.color[c(1, 6, 5, 2)]) +
