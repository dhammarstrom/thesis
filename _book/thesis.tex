...
\hypertarget{transcriptional-regulation-of-training-induced-muscle-remodeling}{%
\subsection{Transcriptional regulation of training-induced muscle remodeling}\label{transcriptional-regulation-of-training-induced-muscle-remodeling}}
...
{[}221{]}.
The same group subsequntly investigated the effect of training volume at an intensity presumably leading to maximal stimulation of protein synthesis (75\% of 1RM).
This analysis revealed a does-response effect in terms of training volume as six-sets of leg extension led to greater protein synthesis and sustained S6K1 phsophorylation
{[}222{]}.
Similarly, a single session consisting of either one or three sets of increased myofibrillar fractional synthetic rate five and 29 hours after exercise and to a larger degree in response to three sets compared to the single set.
This coincided with volume-dependent regulation of S6K1 in the fed state only 29 hours after exercise, however no volume-dependency was seen in p90RSK1 (downstream of ERK) or rpS6 except that only three set led to increased levels five hours after exercise
{[}20{]}.
A comprehensive analysis of the effect of resistance training volume in terms of melecular signaling was performed by Ahtiainen and collegues
{[}22{]}.

\textbackslash begin\{table\}

\textbackslash caption\{(\#tab:lit\_rev\_signaling)Signaling events and protein synthesis in response to resistance exercise of different volumes\}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lrllllll}
\toprule
Sex & Age & Exercise & Intensity & Volume comparison & Target & Time after exercise & Volume dependence\\
\midrule
 &  &  &  &  & Akt Ser473 & 30 minutes & no\\
\cmidrule{6-8}
 &  &  &  &  & mTOR Ser2448 & 30 minutes & no\\
\cmidrule{6-8}
 &  &  &  &  & S6K1 Thr389 & 30 minutes & yes (6 sets higher than 1 and 3 sets)\\
\cmidrule{6-8}
 &  &  &  &  & rpS6 Ser235/236 & 30 minutes & yes (6 sets higher than 1 and 3 sets)\\
\cmidrule{6-8}
 &  &  &  &  & ERK 1/2 Thr202/Tyr204 & 30 minutes & no\\
\cmidrule{6-8}
 &  &  &  &  & p38 Thr180/Tyr182 & 30 minutes & no\\
\cmidrule{6-8}
 &  &  &  &  & p38 (gamma) Thr180/Tyr182 & 30 minutes & no\\
\cmidrule{6-8}
 & \multirow{-8}{*}{\raggedleft\arraybackslash 22} & \multirow{-8}{*}{\raggedright\arraybackslash Bilateral leg press} & \multirow{-8}{*}{\raggedright\arraybackslash 6RM} & \multirow{-8}{*}{\raggedright\arraybackslash 1 vs. 3 vs. 6 sets} & AMPK Thr172 & 30 minutes & no\\
\cmidrule{2-8}
 &  &  &  &  & eIF2B (epsilon) Ser539 & 5 hours & yes (3 sets lower than 1 set)\\
\cmidrule{6-8}
 &  &  &  &  & eIF2B (epsilon) Ser539 & 24 hours & no\\
\cmidrule{6-8}
 &  &  &  &  & eIF2B (epsilon) Ser539 & 29 hours & no\\
\cmidrule{6-8}
 &  &  &  &  & p90RSK1 Thr573 & 5 hours & no\\
\cmidrule{6-8}
 &  &  &  &  & p90RSK1 Thr573 & 24 hours & no\\
\cmidrule{6-8}
 &  &  &  &  & p90RSK1 Thr573 & 29 hours & no\\
\cmidrule{6-8}
 &  &  &  &  & S6K1 Thr389 & 5 hours & no\\
\cmidrule{6-8}
 &  &  &  &  & S6K1 Thr389 & 24 hours & no\\
\cmidrule{6-8}
 &  &  &  &  & S6K1 Thr389 & 29 hours & yes (3 sets higher than 1 set)\\
\cmidrule{6-8}
 &  &  &  &  & rpS6 Ser240/244 & 5 hours & no\\
\cmidrule{6-8}
 &  &  &  &  & rpS6 Ser240/244 & 24 hours & no\\
\cmidrule{6-8}
 &  &  &  &  & rpS6 Ser240/244 & 29 hours & no\\
\cmidrule{6-8}
 &  &  &  &  & MPS & 5 hours & yes\\
\cmidrule{6-8}
\multirow{-22}{*}{\raggedright\arraybackslash Male} &  & \multirow{-14}{*}{\raggedright\arraybackslash Knee extension} & \multirow{-14}{*}{\raggedright\arraybackslash 70 percentage of 1RM} & \multirow{-14}{*}{\raggedright\arraybackslash 1 vs. 3 sets} & MPS & 29 hours & yes\\
\cmidrule{1-1}
\cmidrule{3-8}
 &  &  &  &  & MPS & 0-1 hours & no\\
\cmidrule{6-8}
 &  &  &  &  & MPS & 1-2 hours & no\\
\cmidrule{6-8}
 & \multirow{-17}{*}{\raggedleft\arraybackslash 24} &  &  &  & MPS & 2-4 hours & no\\
\cmidrule{2-2}
\cmidrule{6-8}
 &  &  &  &  & MPS & 0-1 hours & yes\\
\cmidrule{6-8}
 &  &  &  &  & MPS & 1-2 hours & yes\\
\cmidrule{6-8}
 & \multirow{-3}{*}{\raggedleft\arraybackslash 70} &  & \multirow{-6}{*}{\raggedright\arraybackslash 40 percentage of 1RM} &  & MPS & 2-4 hours & no\\
\cmidrule{2-2}
\cmidrule{4-4}
\cmidrule{6-8}
 &  &  &  &  & MPS & 0-1 hours & no\\
\cmidrule{6-8}
 &  &  &  &  & MPS & 1-2 hours & yes\\
\cmidrule{6-8}
 & \multirow{-3}{*}{\raggedleft\arraybackslash 24} &  &  &  & MPS & 2-4 hours & no\\
\cmidrule{2-2}
\cmidrule{6-8}
 &  &  &  &  & MPS & 0-1 hours & yes\\
\cmidrule{6-8}
 &  &  &  &  & MPS & 1-2 hours & yes\\
\cmidrule{6-8}
 & \multirow{-3}{*}{\raggedleft\arraybackslash 70} &  & \multirow{-6}{*}{\raggedright\arraybackslash 75 percentage of 1 RM} &  & MPS & 2-4 hours & no\\
\cmidrule{2-2}
\cmidrule{4-4}
\cmidrule{6-8}
 &  &  &  &  & S6K1 Thr389 & 1 hour & no\\
\cmidrule{6-8}
 &  &  &  &  & S6K1 Thr389 & 2 hours & no\\
\cmidrule{6-8}
 & \multirow{-3}{*}{\raggedleft\arraybackslash 24} &  &  &  & S6K1 Thr389 & 4 hours & no\\
\cmidrule{2-2}
\cmidrule{6-8}
 &  &  &  &  & S6K1 Thr389 & 1 hour & yes\\
\cmidrule{6-8}
 &  &  &  &  & S6K1 Thr389 & 2 hours & yes\\
\cmidrule{6-8}
 & \multirow{-3}{*}{\raggedleft\arraybackslash 70} &  & \multirow{-6}{*}{\raggedright\arraybackslash 40 percentage of 1RM} &  & S6K1 Thr389 & 4 hours & no\\
\cmidrule{2-2}
\cmidrule{4-4}
\cmidrule{6-8}
 &  &  &  &  & S6K1 Thr389 & 1 hour & no\\
\cmidrule{6-8}
 &  &  &  &  & S6K1 Thr389 & 2 hours & yes\\
\cmidrule{6-8}
 & \multirow{-3}{*}{\raggedleft\arraybackslash 24} &  &  &  & S6K1 Thr389 & 4 hours & yes\\
\cmidrule{2-2}
\cmidrule{6-8}
 &  &  &  &  & S6K1 Thr389 & 1 hour & yes\\
\cmidrule{6-8}
 &  &  &  &  & S6K1 Thr389 & 2 hours & yes\\
\cmidrule{6-8}
\multirow{-24}{*}{\raggedright\arraybackslash male} & \multirow{-3}{*}{\raggedleft\arraybackslash 70} & \multirow{-24}{*}{\raggedright\arraybackslash Unilateral leg extension} & \multirow{-6}{*}{\raggedright\arraybackslash 75 percentage of 1 RM} & \multirow{-24}{*}{\raggedright\arraybackslash 3 vs. 6 sets} & S6K1 Thr389 & 4 hours & no\\
\cmidrule{1-8}
 &  &  &  &  & S6K1 Thr389 & 1 hour & no\\
\cmidrule{6-8}
 &  &  &  &  & mTOR Ser2448 & 1 hour & no\\
\cmidrule{6-8}
 & \multirow{-3}{*}{\raggedleft\arraybackslash 21} & \multirow{-3}{*}{\raggedright\arraybackslash Knee extension} & \multirow{-3}{*}{\raggedright\arraybackslash 80 percentage of 1RM} & \multirow{-3}{*}{\raggedright\arraybackslash 1 vs. 3 sets} & Akt Ser473 & 1 hour & no\\
\cmidrule{2-8}
 &  &  &  &  & IRS-I Ser636/639 & 30 minutes & yes\\
\cmidrule{6-8}
 &  &  &  &  & Akt Ser473 & 30 minutes & yes\\
\cmidrule{6-8}
 &  &  &  &  & Erk1/2 Thr202/Tyr204 & 30 minutes & no\\
\cmidrule{6-8}
 &  &  &  &  & p38 MAPK Thr180/Tyr182 & 30 minutes & no\\
\cmidrule{6-8}
 &  &  &  &  & CaMKII Thr286 & 30 minutes & no\\
\cmidrule{6-8}
 &  &  &  &  & LKB1 Ser428 & 30 minutes & no\\
\cmidrule{6-8}
 &  &  &  &  & AMPKa Thr172 & 30 minutes & yes\\
\cmidrule{6-8}
 &  &  &  &  & AS160 Thr642 & 30 minutes & yes\\
\cmidrule{6-8}
 &  &  &  &  & p70S6K Thr421/ Ser424 & 30 minutes & yes\\
\cmidrule{6-8}
 &  &  &  &  & rpS6 Ser235/236 & 30 minutes & yes\\
\cmidrule{6-8}
 &  &  &  &  & rpS6 Ser240/244 & 30 minutes & yes\\
\cmidrule{6-8}
\multirow{-15}{*}{\raggedright\arraybackslash Male} & \multirow{-12}{*}{\raggedleft\arraybackslash 26} & \multirow{-12}{*}{\raggedright\arraybackslash Bilateral leg press} & \multirow{-12}{*}{\raggedright\arraybackslash 10RM} & \multirow{-12}{*}{\raggedright\arraybackslash 5 vs. 10 sets} & eEF2 Thr56. & 30 minutes & no\\
\bottomrule
\end{tabular}}
\textbackslash end\{table\}

Using the same number of sets but manipulating time under tension with repetition speed (6 vs.~1 second) also showed a greater post exercise activation of protein synthesis (myofibrillar, mitochondrial and sarcoplasmic)
{[}104{]}
...
{[}144, 142, 146{]}, meta-analyses conclude in favor of moderate volume protocols {[}23--25,224{]}.
...
Skeletal muscle is a highly adaptable tissue that responds to environmental stress by altering growth rates and differentiation processes. During resistance training, signaling cascades that stimulate muscle plasticity are triggered. Upon repeated exposures, this facilitates growth and a phenotypic shift in a metabolically active direction {[}225{]},
with the opposite happening during inactivity {[}226{]}.
Despite this generalized view, muscle responsiveness and plasticity vary, both in response to different resistance-training protocols {[}227{]} and, perhaps more importantly, between individuals {[}53,\textgreater{} 14{]}.
...
Currently, little is known about the etiology of this variation. However, it is usually associated with phenotypic traits of skeletal muscle {[}228, 195, 229 {]}, which implies interactions with environmental factors, genetics, epigenetics, and composites of the intra physiological milieu {[}69, 230{]}.
...
Previous studies have investigated transcriptome responses to acute resistance exercise {[}231, 119, 232{]}
and chronic resistance training {[}233, 234, 119, 235, 231, 120{]},
as well as described associations between transcriptome characteristics and degrees of muscle growth {[}120, 236{]},
and function {[}237, 238{]}.
Whereas these studies have merited interesting findings, they lack clear coherences in terms of differential expression events, even for classical exercise-inducible genes such as PGC1\(\alpha\) {[}239{]}.
This lack of clear coherence is potentially due to a combination of issues such as differences in study design and methods for synthesis and analysis of transcriptome data. First, biologically founded variability can be attributed to differences in exercise protocols (e.g., differences in exercise-volume or intensity). This makes it difficult to discern a general transcriptome exercise response, as training variables are not standardized between studies. Biological heterogeneity is also caused by differences between research participants, affecting signal-to-noise ratios and making it difficult to discern the effects of single independent factors such as training variables. Design stage decisions such as the use of within-participant designs {[}227, 240{]} are likely to reduce this variation and to provide transcriptome data with increased biological meaningfulness. Second, technical variability can be attributed to decisions made during the bioinformatical treatment of data. As described by Concea \emph{et al.}, there is no optimal pipeline for sequencing technology as new tools keep evolving and emerging, different tools should be explored to an optimum pipeline for the specific type of data {[}241{]}.
To exploit the potential of any study design, there is a need for identifying an appropriate pipeline for transcriptome analyses to ensure a biologically valid interpretation of data. This entails identifying potential violations of common assumptions caused by the experimental model at hand, relating to, for example, data normalization {[}242, 243{]}.

For transcriptome data to provide adequate biological information about a given experimental set-up, numerous bioinformatic steps need to be adopted in a customized manner {[}241, 244{]}.
Of these steps, data normalization is particularly decisive {[}243{]},
as it aims to transform naïve transcript counts into biologically meaningful results. This essentially means expressing them as \emph{per}-cell abundances {[}245{]}.
For most experimental models, this is equivalent to providing transcript-to-total RNA ratios, given the fulfillment of the assumption that total RNA levels remain stable between conditions on a per-unit-cell or per-unit-tissue basis {[}245{]}.
In cell models that exhibit high degrees of plasticity, gene expression events result in increased amounts of total RNA and mRNA transcripts per cell {[}246{]}, specifically violating the assumption that most genes are not differentially expressed {[}245, 242{]}.
We are not aware of any study that has addressed the need to account for such perspectives during transcriptome analyses of skeletal muscle subjected to mechanical stress, such as resistance training. Indeed, this assumption can be expected to be violated, as total RNA content increases markedly on a per-unit-weight basis {[}227{]}, with potential global changes also occurring for the mRNA pool, though this remains unknown. The extent to which total RNA, and therefore ribosomal RNA, increases, coincides with the increase in muscle mass {[}227,195{]}, underlining its importance for cellular growth but also its inevitable presence as a potential confounding factor in RNA sequencing experiments.
...
described in {[}248{]} as the biopsy needle itself could be used to
...
well tolerated {[}248,250{]}. Any reported differences in fiber type
distributions between sampling techniques have been suggested relating
to differences in sampling depth {[}250,251{]}.
...
Melt-curve analyses were performed for all reactions to verify single-product amplification. Gene-specific primers were designed for all targets using Primer-BLAST {[}259{]} and Primer3Plus {[}260{]} and ordered from Thermo Scientific, except for the external RNA control, for which primers were supplied with the kit.
Raw fluorescence data was exported from the platform specific software and amplification curves were modelled with a best-fit sigmoidal model using the qpcR-package {[}261{]} written for R {[}\textbf{R-base?}{]}. Threshold cycles (Ct) were estimated from the models by the second-derivate maximum method with technical duplicates modelled independently.
Amplification efficiencies were estimated for every reaction {[}as described by 262,implemented in 261{]}. For every primer pair, mean amplification efficiencies (\(E\)) were utilised to transform data to the linear scale using \(E^{-Ct}\). Primer sequences and primer characteristics (i.e.~average primer efficiencies and Ct values) are presented in Table 2. Gene expression data was log-transformed prior to statistical analysis. As Ct-values, but not efficiencies are related to RNA integrity {[}263{]}, RQI scores were used in the statistical treatment of qPCR data to control for potential degradation effects on a by target basis (see below).
...
In Study II, an initial sample size calculation was made based on a best case scenario. Data from Brook et al. {[}264{]} indicated that a within-participant differences in RNA per tissue weight of \(15\%\) could be detected with seven participants in the experimental group (e.g.~2.79 (0.65) to 3.21 (0.74) \SI{}{\micro\gram\per\micro\litre}, \(\alpha<0.05\), \(\beta<0.2\), effect size=1.2). The control group was included in the study as a negative control primarily for the sake of systems validation of experimental procedures regarding measures of e.g.~ribosomal biogenesis. With a balanced design, accounting for drop-outs eight participants were required in each group. After a preliminary analysis of the experiment (experimental group \emph{n = }7, control group \emph{n = }7){[}265{]}, additional participants (experimental group \emph{n =} 4, control group \emph{n = }1) were recruited to the study to increase the precision of estimates, primarily in analyses within the experimental group.
...
\bottomrule
\multicolumn{4}{l}{\textsuperscript{a} Estimates from Wernbom et al. {[}267{]}}\\
...
Indeed, in the present study we observed volume-dependence of mTOR phosphorylation at Ser2448, which could be a sign of negative feedback from mTORC1-based activation of S6K1 {[}192{]}.
{[}24{]};
{[}23{]};
{[}25{]}{]}.
...
\leavevmode\hypertarget{ref-RN2847}{}%
\CSLLeftMargin{{[}220{]} }
\CSLRightInline{Pereira MG, Dyar KA, Nogara L, Solagna F, Marabita M, Baraldo M, et al. Comparative analysis of muscle hypertrophy models reveals divergent gene transcription profiles and points to translational regulation of muscle growth through increased mTOR signaling. Frontiers in Physiology 2017;8:968--8. \url{https://doi.org/10.3389/fphys.2017.00968}.}
