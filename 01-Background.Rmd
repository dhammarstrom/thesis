...
Kadi *et al.* reported that although the number of satellite cells increased in response to training, the addition of myonuclei did not, 
...
[@RN765].<!-- description of the age/sex characteristics of clusters in 2868 -->
...
A similar clustering-approach as performed in [@RN2868] did subsequently not find any difference in myonuclear addition between different response clusters in a homogeneous sample in terms of age (and sex)
...
[@RN804]<!-- Differentiating satellite cells increased  -->
