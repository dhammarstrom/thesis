...
Systematic resistance training typically increases muscle mass and strength, adaptations through which many of the beneficial effects on health (increased amino acid storage physical independence) and athletic performance are conveyed. 
Muscle growth is indeed a well characterized response to resistance training.
On the whole muscle level, healthy untrained individuals can be expected to increases their muscle mass ~ 5-20% when training is conducted over two weeks to 6 months
[@RN1741; <!-- Ahtianen -->
@RN346;<!-- Wernbom  -->
@RN764].<!-- Hubal 2005 elbow flexor 18.9% increase -->
Relative growth can be expected to be more pronounced in upper- compared to lower-body muscles when loading patterns are similar
[@RN346;<!-- Wernbom  -->
...
[@2739; <!-- Welle 1996 larger incr in csa in upper body --> 
...
Together this underlines that both non-modifiable (e.g. sexual dimorphism and age) and modifiable factors (e.g. training variables and protein supplementation) affects training induced hypertrophy.

Time course studies of resistance training-induced whole muscle growth in untrained individuals show that muscle hypertrophy occurs linearly over the first 4 to 12 weeks of training
...
This development effectively plateaus after e
<!-- Comparing trained with long term trained individuals -->
...
whole muscles growth in response to short term resistance training occurs primarily as a consequence of growth of single muscle fibers.
...
An increased muscle mass transfers to muscle strength trough an increase in contractile elements of the muscle.
...
occupied by these contractile elements, called myofibrils.
...
@Arora2020].<!-- Arora 2020 differences between pipelines in gene abundance estimates --> 
