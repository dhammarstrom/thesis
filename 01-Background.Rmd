...
In adult human skeletal muscles, fiber types can be identified based on their myosin heavy chain isoform composition. Pure fiber type express a single mysoin heavy chain isoform whereas hybrid fibers co-espress isoforms.
Protein isoform expression is determined transcriptionally  
Expression of the different isoforms are controlled 
*MYH7*
*MYH2* myosin heavy chain IIA
*MYH1* myosin IIX

Different fiber types have specific contractile 
[@RN846]<!-- Harridge 1996 specific contraction characteristics in different fiber types determined by myosin heavy chain-->
and metabolic characteristics

effectively matching the demands and activity patterns of segments of the same muscle and different muscle groups
[@RN]
...
In response to mechanical loading fiber type transitions occur. 

However in response to resistance training, designed for muscle hypertrophy and strength gains, fiber types identified as Type IIX are less nomerous after training.
