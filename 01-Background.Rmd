...
Previous studies Using large-scale techniques to investigate transcriptome characteristics in response to resistance-exercise or training, studies have evaluated [@RN1825;<!-- Gordon 2012 Diff expr after acute exercise in trained vs. untrained (identifies ECM as higher in trained)-->
...
From a methodological point of view, skeletal muscle subjected to e.g. resistance training, concomitant with muscle hypertrophy thus both exhibit large global scale changes to the RNA pool as well as important *qualitative* changes to RNA sub-populations.
...
In cell culture experiments, the common denominator for transcripis abundances [@RN2359]<!-- Loven 2012 et al  -->.
...
<!-- Stepto 2009 Difference between trained (strength and endurance) and untrained controls. A gene clsuter correlated with strength -->
