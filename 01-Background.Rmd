...
#### Measuring mTORC1 activity
The most common approach to estimate mTORC1 activity is by use of immunoblotting and phospho-specific antibodies.
S6K1 phosphorylated at Thr\textsuperscript{389}


Activity along the mTORC1 signaling pathway readily changes as a function of training period length.
[@RN1809]




[@RN2843]<!-- Raught 2004 phosphorylation of eif4b affects translation initiation -->
...
present in two isoforms of about 70 and 85 kDa with different localization.
...
and <span custom-style="CHANGE">is accompanied by increases in </span>myofibrillar protein synthesis [@RN791]<!-- Burd -->,
...
inhibition of ribosomal RNA (rRNA) transcription or inhibition of up-stream transcription factors act to diminish muscle cell growth
...
Additional observational data from human resistance-training studies also indicates a relationship between increased ribosome abundance and magnitude of muscle growth
...
Together this underlines the importance of ribosomal abundance, and thus also ribosomal biogenesis in resistance training-induced muscle hypertrophy.
...
Synthesis of new ribosomes is a complex and energy demanding process. It involves the synthesis of both ribosomal proteins and the four mature rRNA as well as their assembly into functional ribosomal subunits
...
Such activation is at least partly controlled by mTORC1 activity, with its inhibition being associated with blocked UBF phosphorylation leading to inability to recruit secondary factors to the rDNA promotor and stimulate rRNA transcription
[@RN1632; <!-- Nader rapamycin block UBF availability  -->
@RN2564].<!-- Hannan mTOR block in postmitotic cardimyocytes  -->
S6K1 was shown to be important for rapamycin-induced inhibition of rRNA transcription 
[@RN2564]
but UBF was not a S6K1 substrate


UBF phosphorylation 117 201 mediated by mitogen induced ERK signaling needed for rDNA bining
[@RN2604]<!-- Stefanovsky 2001 MEK specific inhibition under mitogen activation inhibits rRNA transcription and UBF phosphorylation at 117 and 201 -->
UBF is phosphorylated by mTOR at carboxy-terminal activation domain
[@RN2564]<!-- Hannan rapamycin inhibits UBF phosphorylation and its ability to recruit RRn3 and other secondary transcription factors -->
